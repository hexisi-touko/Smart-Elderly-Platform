<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="关联监护人ID" prop="guardianId">
        <el-input
          v-model="queryParams.guardianId"
          placeholder="请输入关联监护人ID"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="elderly_guardianList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关联监护人ID" align="center" prop="guardianId" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="elderly_guardianRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="关联监护人ID" prop="guardianId">
          <el-input v-model="form.guardianId" placeholder="请输入关联监护人ID" />
        </el-form-item>
        <el-form-item label="授权状态" prop="authorizationStatus">
